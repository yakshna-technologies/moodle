...
class __Mustache_0659ebc5aa32c9ed00ca655d6860e802 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '            <div data-filterregion="value" class="d-md-flex flex-column align-items-start flex-lg-row"></div>
';
        $buffer .= $indent . '
';
