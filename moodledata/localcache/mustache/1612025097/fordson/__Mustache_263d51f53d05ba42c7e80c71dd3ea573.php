...
class __Mustache_263d51f53d05ba42c7e80c71dd3ea573 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block1fe1559f5747943277a04bd13170cb3f'),
            ));
...
';
    ...
    public function block1fe1559f5747943277a04bd13170cb3f($context)
    {
        $indent = $buffer = '';
